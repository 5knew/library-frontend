    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/add-book" element={
          <ProtectedRoute acceptedRoles={['ROLE_LIBRARIAN']}>
            <ProtectedLayout>
              <AddBook />
            </ProtectedLayout>
          </ProtectedRoute>
        ...
        <Route path="/users" element={
          <ProtectedRoute acceptedRoles={['ROLE_ADMIN', 'ROLE_LIBRARIAN']}>
            <ProtectedLayout>
              <UsersPage />
            </ProtectedLayout>
          </ProtectedRoute>
        ...
        <Route path="/categories" element={
          <ProtectedRoute acceptedRoles={['ROLE_LIBRARIAN', 'ROLE_ADMIN']}>
            <ProtectedLayout>
              <CategoryForm />
            </ProtectedLayout>
          </ProtectedRoute>
        ...
        <Route path="/add-user" element={
          <ProtectedRoute acceptedRoles={['ROLE_ADMIN']}>
            <ProtectedLayout>
              <AddUserPage />
            </ProtectedLayout>
          </ProtectedRoute>
        ...
        <Route path="/book-copies" element={
          <ProtectedRoute acceptedRoles={['ROLE_LIBRARIAN', 'ROLE_ADMIN', 'ROLE_STUDENT']}>
            <ProtectedLayout>
              <BookCopyList />
            </ProtectedLayout>
          </ProtectedRoute>
        ...
        <Route path="/add-book-copy" element={
          <ProtectedRoute acceptedRoles={['ROLE_LIBRARIAN', 'ROLE_ADMIN']}>
            <ProtectedLayout>
              <AddBookCopy />
            </ProtectedLayout>
        ...
        <Route path="/update-book-copy/:bookCopyId" element={
          <ProtectedRoute acceptedRoles={['ROLE_LIBRARIAN', 'ROLE_ADMIN']}>
            <ProtectedLayout>
              <UpdateBookCopy />
            </ProtectedLayout>
        ...
        <Route path="/books-with-copies" element={
          <ProtectedRoute acceptedRoles={['ROLE_LIBRARIAN', 'ROLE_ADMIN', 'ROLE_STUDENT']}>
            <ProtectedLayout>
              <BooksWithCopies />
            </ProtectedLayout>
        ...
        <Route path="/profile" element={
          <ProtectedRoute acceptedRoles={['ROLE_ADMIN', 'ROLE_LIBRARIAN', 'ROLE_STUDENT']}>
            <ProtectedLayout>
              <ProfilePage />
            </ProtectedLayout>
          </ProtectedRoute>
